        ...
        <div class="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <template v-else>
            ...
            <div>
              ...
              >
                <span class="text-xs uppercase tracking-widest text-muted-foreground">Règles d'affichage (Couche 2)</span>
                <ChevronDown v-if="rulesExpanded" class="w-4 h-4 text-muted-foreground" />
                <ChevronRight v-else class="w-4 h-4 text-muted-foreground" />
              </Button>

              <div v-if="rulesExpanded" class="mt-4 space-y-6">
